...
(function(xplayer, $) {
	...
	$.extend(xplayer.Html5UI.fn, {
		...
		buildplaypause: function(player, $video, $control, $UILayer) {
			...
			var $playBtn = $UILayer.find(xplayer.html5skin.elements.play),
				videoTag = $video[0],
				t = this,
				isClick = false;
			...
			$video.on("paused pause", function() {
				...
				$playBtn.addClass("xplayer_play").removeClass("xplayer_pause");
			}).on("play playing", function() {
				$playBtn.addClass("xplayer_pause").removeClass("xplayer_play");
			})
